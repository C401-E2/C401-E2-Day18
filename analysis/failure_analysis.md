...
|-----|--------|-----------|-----------|
| Khohk | M1: Chunking | x | 8/8 |
| Khohk | M2: Hybrid Search | x | 5/5 |
| Khohk | M3: Reranking | x | 5/5 |
| Khohk | M4: Evaluation | x | 4/4 |
...
2. **Biggest challenge:** Context Recall giam -0.15 — cac cau hoi liet ke (Dieu 9 co 11 quyen, du lieu co ban co 12 loai) bi phan tan sang qua nhieu chunk nho (400 chars). Top-5 reranked chunks khong cover het, dan den recall thap du search co tim dung.
